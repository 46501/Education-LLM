      ...
      <div className="p-4 bg-transparent border-t-0 mb-4 shrink-0">
        <form onSubmit={handleSend} className="relative max-w-3xl mx-auto shadow-sm rounded-2xl bg-white border border-gray-200 overflow-hidden focus-within:ring-2 focus-within:ring-indigo-500 focus-within:border-transparent transition-all">
          <textarea
            ...
            className="w-full max-h-32 min-h-[56px] p-4 pr-16 resize-none focus:outline-none text-gray-800 bg-transparent"
            rows={1}
          />
          <button
            type="submit"
            disabled={isTyping || !input.trim()}
            className="absolute right-3 bottom-3 p-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 disabled:opacity-50 disabled:hover:bg-indigo-600 transition"
          >
